    ...
    <>
      ...
      <SectionWindow className="mt-5">
        <ContentTwo
          colLeft={6}
          colRight={6}
          ColLeftContent={<Image src={imagens.bemVindo} fluid />}
          ColRightContent={
            <TextConteiner>
              <Text colors={Colors.darkBlue}>
                Que bom vê-lo(a) novamente! Estamos começando o{" "}
                <strong>Módulo 2</strong> vamos estudar como podem atuar as
                estratégias do marketing dentro do cenário virtual. Para isso
                vamos conhecer os conceitos do marketing digital e como o
                negócio pode ser pensado dentro desses conceitos.
              </Text>
            </TextConteiner>
          }
        />
        ...
        <ContentOpacity
          ...
          ColRightContent={
            ...
            >
              <Row>
                <Col md={12}>
                  <TitleSection>{"objetivo".toLocaleUpperCase()}</TitleSection>
                </Col>
                <Col md={12}>
                  <Text colors={Colors.black}>
                    O objetivo do módulo 2 é traduzir para o aluno os conceitos
                    mais utilizados quando se fala em marketing digital. Além
                    disso, será apresentado as estratégias de mercado mais
                    conhecidas, a relação com os negócios e a aplicabilidade
                    dessas estratégias nas redes sociais, hoje principal
                    plataforma do marketing digital.
                  </Text>
                </Col>
              </Row>
            </TextConteiner>
